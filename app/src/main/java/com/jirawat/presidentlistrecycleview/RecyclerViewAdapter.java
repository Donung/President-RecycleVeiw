...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.tv_presElectionDate.setText(String.valueOf(presidentList.get(position).getDataOfElection()));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tv_presName = itemView.findViewById(R.id.tv_dateElection);
            tv_presElectionDate = itemView.findViewById(R.id.tv_presName);
